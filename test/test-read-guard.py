...
TESTS = [
    ...
    ("Read attack_surface.json allows",
     ...
     0,
     None),
    ("Read recon-summary.json allows",
     {"tool_input": {"file_path": f"{SESSION}/recon-summary.json"}},
     0,
     None),
    ...
    ("Bash cat attack surface allows",
     ...
     0,
     None),
    ("Bash cat compact recon summary allows",
     {"tool_input": {"command": f"cat {SESSION}/recon-summary.json"}},
     0,
     None),
