...
//   * Exactly 8 canonical consumer entries per Y-D19 rev 4.1 + Plane-Delta S12/C9.
...
test("STIGMERGIC_CONSUMERS contains exactly the 8 canonical Y-D19/Plane-Delta entries", () => {
  assert.equal(STIGMERGIC_CONSUMERS.length, 8);
