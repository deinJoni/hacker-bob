...
allowed-tools:
  ...
  - mcp__bountyagent__bob_read_surface_routes
  - mcp__bountyagent__bob_import_http_traffic
  - mcp__bountyagent__bob_public_intel
  - mcp__bountyagent__bob_ingest_schema_doc
  - mcp__bountyagent__bob_query_schema_contracts
  - mcp__bountyagent__bob_run_doc_delta
  ...
  - mcp__bountyagent__bob_chain_frontier
  - mcp__bountyagent__bob_chain_ancestry
  ...
  - mcp__bountyagent__bob_build_verification_adjudication
  - mcp__bountyagent__bob_read_evidence_packs
  - mcp__bountyagent__bob_read_grade_verdict
  - mcp__bountyagent__bob_init_session
  - mcp__bountyagent__bob_read_session_state
  ...
  - mcp__bountyagent__bob_wave_handoff_status
  ...
  - mcp__bountyagent__bob_set_operator_note
  - mcp__bountyagent__bob_clear_operator_note
  - mcp__bountyagent__bob_clear_terminal_block
  - mcp__bountyagent__bounty_report_written
  - mcp__bountyagent__bob_read_capability_playbook
  - mcp__bountyagent__bob_get_context_budget
  - mcp__bountyagent__bob_select_technique_packs
  - mcp__bountyagent__bob_read_technique_pack
  - mcp__bountyagent__bob_log_technique_attempt
  - mcp__bountyagent__bob_read_tool_telemetry
  - mcp__bountyagent__bob_read_pipeline_analytics
  - mcp__bountyagent__bob_read_capability_metrics
  - mcp__bountyagent__bob_evaluate_capabilities
  - mcp__bountyagent__bob_ingest_audit_report
  - mcp__bountyagent__bob_query_audit_reports
  - mcp__bountyagent__bob_suggest_invariants
  - mcp__bountyagent__bob_run_invariant_for_finding
  - mcp__bountyagent__bob_read_invariant_runs
  - mcp__bountyagent__bob_extract_routes
  - mcp__bountyagent__bob_build_symbol_surface_index
  - mcp__bountyagent__bob_summarize_diff_impact
  - mcp__bountyagent__bob_record_surface_leads
  - mcp__bountyagent__bob_read_surface_leads
  - mcp__bountyagent__bob_promote_surface_leads
  - mcp__bountyagent__bob_build_surface_graph
  - mcp__bountyagent__bob_query_surface_graph
...
## Lenses
Lenses are work-scope vocabulary attached to each assignment by the scheduler. Operators may request a lens, but routing is MCP-owned via `bob_schedule_tasks` and `bob_read_assignment_brief.data.task_lens`. The canonical lens values are `seed_mapping`, `surface_scout`, `behavior_probe`, `control_check`, `claim_development`, `impact_correlation`, `reproduction_check`, `evidence_capture`, and `coverage_closeout`. Each lifecycle state below names the lenses the operator is most likely to invoke at that state.
