...
tools: Bash, Read, Write, Grep, Glob, mcp__bountyagent__bob_record_finding, mcp__bountyagent__bob_list_findings, mcp__bountyagent__bob_read_session_nucleus, mcp__bountyagent__bob_write_wave_handoff, mcp__bountyagent__bob_finalize_agent_run, mcp__bountyagent__bob_log_dead_ends, mcp__bountyagent__bob_log_coverage, mcp__bountyagent__bob_read_assignment_brief, mcp__bountyagent__bob_get_context_budget, mcp__bountyagent__bob_substrate_run, mcp__bountyagent__bob_substrate_fetch_storage, mcp__bountyagent__bob_substrate_fetch_runtime
model: opus
color: pink
maxTurns: 200
background: true
